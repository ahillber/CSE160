...
function groundSky() {
    ...
    let normalCube = new Cube();
    normalCube.color = [0.8, 0.8, 0.8, 1.0];
    normalCube.textureNum = -3;
    normalCube.matrix.translate(-1, -0.5, 2.5);
    normalCube.render();
    ...
    //sphere.matrix.rotate(180, 0,1,0);
    sphere.matrix.translate(2, 0.2, 3);
    sphere.render();
